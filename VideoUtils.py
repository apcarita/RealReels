...
def addSubtitles(video_path, srt_path, output_path):
    ...
    for subtitle in subtitles:
        ...
        text_clip = TextClip(line + add, fontsize=90, font='Big-Caslon-Medium', color='White', bg_color='none', size=(video.size[0]*5/6, video.size[1]*2/6), method='caption', align='north')
